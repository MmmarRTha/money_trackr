<details class="group relative inline-block text-left">
    <summary
        class="[&::-webkit-details-marker]:hidden flex size-9 cursor-pointer list-none items-center justify-center rounded-lg border border-neutral-700 bg-neutral-800 text-neutral-400 transition hover:border-neutral-600 hover:bg-neutral-700 hover:text-white focus:ring-2 focus:ring-fuchsia-500 focus:outline-none"
    ...
    <div class="absolute right-0 z-50 mt-2 w-56 origin-top-right overflow-hidden rounded-xl border border-neutral-700 bg-neutral-900 p-1.5 shadow-2xl ring-1 shadow-black/30 ring-black/20">
        ...
        >
            ...
            <span>
                ...
                <span class="mt-0.5 block text-xs text-neutral-500"> View budget details </span>
            </span>
        </a>
        ...
        >
            <span class="flex size-8 shrink-0 items-center justify-center rounded-lg bg-neutral-800 text-neutral-400 transition group-hover/item:bg-neutral-700 group-hover/item:text-fuchsia-400">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" class="size-4">
                    ...
                    />
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 6.75 17.25 9" />
                </svg>
            </span>

            <span>
                <span class="block font-medium">Update Budget</span>
                <span class="mt-0.5 block text-xs text-neutral-500"> Edit budget settings </span>
            </span>
        </a>
